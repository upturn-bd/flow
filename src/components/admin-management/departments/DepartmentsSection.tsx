              ...
              >
                ...
                <div className="flex gap-2">
                  ...
                  <motion.button
                    ...
                    className={`px-3 py-1.5 rounded-md bg-red-50 text-red-600 text-sm flex items-center gap-1 hover:bg-red-100 transition-colors ${departmentDeleteLoading === dept.id ? 'opacity-50 cursor-not-allowed' : ''}`}
                  >
                    <X size={14} />
