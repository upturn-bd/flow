  ...
  return (
    <section className="bg-surface-primary p-4 sm:p-6 rounded-lg border border-border-primary shadow-sm">
      <div className="border-b border-border-primary pb-4 mb-4">
        ...
        <p className="text-sm text-foreground-tertiary">Manage job positions and roles</p>
      </div>
            ...
            positions.map((position) => (
              ...
              >
                <div className="flex items-center mb-2 sm:mb-0">
                  <div className="w-8 h-8 bg-background-secondary rounded-full flex items-center justify-center text-foreground-secondary mr-3">
                ...
                <div className="flex gap-2 w-full sm:w-auto justify-end">
                  <button
                    ...
                    className="px-3 py-1.5 rounded-md bg-background-secondary text-foreground-secondary text-sm flex items-center gap-1 hover:bg-background-tertiary transition-colors"
                  >
                    <Eye size={14} />
