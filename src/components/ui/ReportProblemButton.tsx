...
export default function ReportProblemButton({
  ...
  const variantClasses = {
    default: "px-4 py-2 text-sm bg-red-50 text-red-700 hover:bg-red-100 border border-red-200",
    compact: "px-3 py-1.5 text-xs bg-red-50 text-red-700 hover:bg-red-100 border border-red-200",
    "icon-only": "p-2 bg-red-50 text-red-700 hover:bg-red-100 border border-red-200",
  };
