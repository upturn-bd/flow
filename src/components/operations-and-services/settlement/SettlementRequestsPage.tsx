            ...
            <div className="space-y-4">
              <AnimatePresence>
                {settlementRequests.map((req) => {
                  const settlement = req as unknown as SettlementRequest;
                  return (
                    <motion.div
                      key={settlement.id}
                    ...
                    >
                        ...
                        {settlement.attachments && settlement.attachments.length > 0 && (
                          <div className="space-y-2">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {settlement.attachments.map((attachment, idx) => (
                                <a
                                  key={idx}
                                  href={attachment}
                                  target="_blank"
                      ...
                      <div className="flex flex-wrap justify-end gap-4 pt-2">
                        <motion.button 
                          ...
                          whileTap={{ scale: 0.98 }}
                          onClick={() => settlement.id !== undefined && handleUpdateRequest("Rejected", settlement.id)}
                        ...
                        <motion.button 
                          whileHover={{ scale: 1.02 }}
                          whileTap={{ scale: 0.98 }}
                          onClick={() => settlement.id !== undefined && handleUpdateRequest("Approved", settlement.id)}
                          disabled={processingId === settlement.id}
