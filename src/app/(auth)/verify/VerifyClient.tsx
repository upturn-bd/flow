        ...
        <section className="bg-gradient-to-br from-background-secondary to-primary-50 text-foreground-primary min-h-screen flex flex-col">
            <div className="flex flex-col md:flex-row h-full min-h-screen">
                ...
                <div className="bg-[#001731] flex flex-col items-center justify-center text-white p-8 md:w-2/6 w-full min-h-[160px] md:min-h-0 relative">
                    ...
                    <p className="text-sm text-foreground-tertiary text-center mt-2 max-w-xs">
                        Empowering teams to work smarter, faster, and better — together.
                    </p>

                    {/* Decorative gradient blob */}
                    <div className="absolute bottom-0 left-0 w-40 h-40 bg-primary-400/20 blur-3xl rounded-full translate-x-[-50%] translate-y-[50%]" />
                </div>
                ...
                <div className="flex flex-1 items-center justify-center px-6 py-12 md:px-16 lg:px-32">
                    <div className="bg-surface-primary/70 backdrop-blur-xl border border-border-primary w-full max-w-md md:max-w-lg p-10 md:p-14 rounded-3xl shadow-xl text-center">
                        ...
                        <p className="text-foreground-secondary mb-8 leading-relaxed text-sm md:text-base">
                            ...
                            <span className="font-semibold underline cursor-pointer text-primary-600">
                                ({email})
                            </span>
                        ...
                        <Link href="/login">
                            <button className="px-8 py-3 rounded-full bg-primary-600 text-white font-semibold shadow-lg transition-transform transform hover:scale-105 hover:bg-primary-700 focus:outline-none focus:ring-4 focus:ring-primary-300">
                                Go to Login
                            </button>
                        </Link>
                    </div>
