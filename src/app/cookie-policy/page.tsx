    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-sm p-8">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">2. Functionality Cookies</h3>
          <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">3. Analytics and Performance Cookies</h3>
          <p className="text-gray-700 mb-4">
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-6">
            ...
            <li>
              <strong>Opt-Out Links:</strong> You can opt out of Google Analytics by installing the Google Analytics Opt-out Browser Add-on: <a href="https://tools.google.com/dlpage/gaoptout" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">https://tools.google.com/dlpage/gaoptout</a>
            </li>
          </ul>

          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">How to Control Cookies in Your Browser</h2>
          <p className="text-gray-700 mb-4">
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-6">
            <li><a href="https://www.aboutcookies.org" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">www.aboutcookies.org</a></li>
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-6">
            <li><a href="https://support.google.com/accounts/answer/61416" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">Google Chrome</a></li>
            <li><a href="https://support.microsoft.com/en-us/microsoft-edge" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">Microsoft Edge</a></li>
            ...
            <li><a href="https://support.apple.com/en-us/HT201265" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">Safari (Desktop)</a></li>
            <li><a href="https://support.apple.com/en-us/HT201265" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">Safari (Mobile)</a></li>
            <li><a href="https://support.google.com/chrome/answer/95647" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">Android Browser</a></li>
          </ul>

          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Other Tracking Technologies</h2>
          <p className="text-gray-700 mb-6">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Do Not Track Signals</h2>
          <p className="text-gray-700 mb-6">
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-6">
            ...
            <li>By visiting our website: <a href="https://flow.upturn.com.bd" className="text-blue-600 hover:underline">https://flow.upturn.com.bd</a></li>
            <li>By mail: 154 Shantinagar, Flat - B6, Paltan, Dhaka - 1217, Bangladesh</li>
          </ul>

          <div className="mt-8 pt-6 border-t border-gray-200">
            <p className="text-gray-600 text-sm">
              For more information about how we handle your personal data, please see our <a href="/privacy-policy" className="text-blue-600 hover:underline">Privacy Policy</a>.
            </p>
          </div>
        </div>
      </div>
