...
### 🟡 PRIORITY 2: Stakeholder Process Components (Core Business)
...
- [ ] `src/components/stakeholder-processes/StepManager.tsx` - 30+ instances (partial 1/30)
- [ ] `src/components/stakeholder-processes/FormulaEditor.tsx` - 15+ instances

### 🟡 PRIORITY 2: Stakeholder Components

- [ ] `src/components/stakeholders/StakeholderTransactions.tsx` - 30+ instances
